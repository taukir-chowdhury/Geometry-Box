...
class Paint():
    def __init__(self,root):
        ...
        self.color_frame = LabelFrame(self.root,text='COLOR',font= ('MS serif',11,'bold'), bd=5,relief=RIDGE,bg="white",fg="gray")
        self.color_frame.place(x=0,y=30,width=70,height=185)
        colors = ['#ff0000','#ff6600','#99ff33','#00ffff','#ff99ff','#ffffff','#800000','#ffff00','#006600','#000099','#6600cc','#000000']
        i=j=0
        for color in colors:
            ...
            if i==6:
                i=0
                j=1
        self.pen_button = Button(self.root,text="Draw",font= ('MS serif',12,'bold'),bd=4,bg='#ffffcc',fg='#cc9900',command=self.ink,width=6,relief=RIDGE)
        self.pen_button.place(x=0,y=240)

        self.eraser_button = Button(self.root,text="Erase",font= ('MS serif',12,'bold'),bd=4,bg='#ccffff',fg='#000066',command=self.eraser,width=6,relief=RIDGE)
        self.eraser_button.place(x=0,y=290)

        self.canvas_color_button = Button(self.root,text="Canvas",font= ('MS serif',12,'bold'),fg='#993366',bd=4,bg='#ffcccc',command=self.canvas_color,width=6,relief=RIDGE)
        self.canvas_color_button.place(x=0,y=340)

        self.clear_button = Button(self.root,text="Clear",font= ('MS serif',12,'bold'),bd=4,bg='#ccff99',fg='#006600',command=lambda : self.canvas.delete("all"),width=6,relief=RIDGE)
        ...
        self.pen_size_scale_frame = LabelFrame(self.root,text="SIZE",bd=5,bg='white',fg='gray',font=('MS serif',12,'bold'),relief=RIDGE)
